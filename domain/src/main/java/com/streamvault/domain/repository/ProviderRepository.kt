...
interface ProviderRepository {
    ...
    suspend fun loginXtream(serverUrl: String, username: String, password: String, name: String): Result<Provider>
    suspend fun validateM3u(url: String, name: String): Result<Provider>
